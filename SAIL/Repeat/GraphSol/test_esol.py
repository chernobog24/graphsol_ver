...
# private library
from dataset_esol import get_loader
from utils import *
...
# dataset setting Repeat\GraphSol\data\preprocess\esol\esol_test.pickle
    ...
    with open(f'{args.result_path}/esol_seed_{args.seed}/{model.__class__.__name__}_{dataset_name}.txt', 'w') as f:
        ...
        for model_path in sorted(model_paths):
            ...
            with torch.no_grad():
                ...
                print(results_dict,predictions_dict)
                #save both to text file
                with open(f'results.txt', 'w') as f:
                    f.write(str(results_dict))
                with open(f'predictions.txt', 'w') as f:
                    f.write(str(predictions_dict))
                exit()
